...
ACCELERATE_LOG_LEVEL=info accelerate launch --config_file gpu.yaml dpo.py \
    ...
    --dataset_name Datasets/processed/1b_math_pair.json \
    --learning_rate 2e-7 \
    --num_train_epochs 3 \
    ...
    --logging_steps 5 \
    --output_dir ./model/Meta-Llama-3.2-1B-Instruct-NEW-dpo-gsm8k-math-3epoch-lr2e-7-bs16-entropy_non_linear1 \
